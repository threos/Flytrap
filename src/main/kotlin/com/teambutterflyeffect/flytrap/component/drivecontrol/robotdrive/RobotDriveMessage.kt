...
class RobotDriveMessage(intent: Intent, data: RobotDriveData, val allowModifier: Boolean = true, timeoutInMillis: Long = 100) : DataMessage<RobotDriveData>(intent, data, timeoutInMillis = timeoutInMillis)
